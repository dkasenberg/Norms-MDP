...
public class Factory {
	...
	public interface GarbageCollectionListener {
        ...
        void onStart(int num, int size, int free, long totalTime);
        ...
        void onStop(int num, int size, int free, long time, long totalTime);
	}
	...
	public interface ResizeListener {
        ...
        void onStart(int num, int oldSize, int newSize, long totalTime);
        ...
        void onStop(int num, int oldSize, int newSize, long time, long totalTime);
	}
	...
	public class BDDImpl implements BDD {
		...
		public BDD ite(BDD thenBDD, BDD elseBDD) {
			assertNotNull(thenBDD);
			assertNotNull(elseBDD);
