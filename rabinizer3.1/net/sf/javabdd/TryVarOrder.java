...
public class TryVarOrder {
    ...
    void initBDDFactory(String s) {
        try {
            ...
            bdd = m.invoke(null, s, new Integer(nodeTableSize), new Integer(cacheSize));
            m = c.getMethod("setMaxIncrease", int.class);
            m.invoke(bdd, new Integer(maxIncrease));
    ...
    void initBDDOperation() throws Exception {
        ...
        m.invoke(bddoperation, new Integer(op.id));
    ...
    void setVarOrder(boolean reverse, String varOrderToTry) throws Exception {
        ...
        m.invoke(bddoperation, Boolean.valueOf(reverse), varOrderToTry);
    }
    ...
    long doIt() throws Exception {
        ...
        Long result = (Long) m.invoke(bddoperation);
